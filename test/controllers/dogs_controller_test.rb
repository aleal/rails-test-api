...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { name: @dog.name, picture: @dog.picture, user_id: @dog.user_id } }, as: :json
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { name: @dog.name, picture: @dog.picture, user_id: @dog.user_id } }, as: :json
    assert_response 200
  end
